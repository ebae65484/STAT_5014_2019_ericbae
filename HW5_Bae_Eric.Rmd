...
I defined my tolerance level as $\sum_i^n (h_0(x_i) - h_1(x_i))^2 < 0.001$. Doing so resulted in my $\Theta_0 \approx 0.9695$ and $\Theta_1 \approx 2.0016$.  
...
That way we can use solve((q - r) %*% B
